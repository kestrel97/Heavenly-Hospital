//BISMIL-ALLAH-IR-RAHMAN-IR-RAHEEM
...
makeappointment(int d){ 	
	...
	a<<id<<endl;
	check=true;
   	cout<<"appointment successfully done....";
	 }
...
bool checkpass(string pass){
	string password="Vendetta";//operator overloadig cAN BE DONE.
	if(password==pass){
		return true;
	}
	else
...
cout<<"press 2 to go to appointment section"<<endl;
cout<<"For Administration:"<<endl;
cout<<"press 3 to update Doctor"<<endl;
cin>>ans;
 while(cin.fail()) {
        cout<<"enter an integer from above choices"<<endl;
        cin.clear();
